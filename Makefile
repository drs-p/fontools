...
dist:
	...
	for name in afm2afm autoinst ot2kpx; do pod2man --center="Marc Penninga" --release="fontools" --section=1 fontools/bin/$${name} - | groff -Tps -man - | ps2pdf - fontools/doc/$${name}.pdf; done
